...
// ✨ Sistema de colores completamente renovado - Comenzando con COLORES VIBRANTES NUEVOS ✨
export const ALL_COLOR_SCHEMES: ColorScheme[] = [
  
  // ==================== 🌟 COLORES VIBRANTES PRINCIPALES (basados en la imagen) ====================
  { name: 'vibrant-purple', gradient: 'from-purple-500 via-purple-600 to-violet-700', category: 'Vibrantes', icon: '🌟' },
  { name: 'vibrant-cyan', gradient: 'from-cyan-400 via-cyan-500 to-teal-600', category: 'Vibrantes', icon: '🌟' },
  
  // ==================== ⚡ MORADOS ELÉCTRICOS ====================
  { name: 'electric-purple', gradient: 'from-purple-400 via-violet-500 to-purple-700', category: 'Morados', icon: '⚡' },
  { name: 'royal-purple', gradient: 'from-indigo-500 via-purple-600 to-violet-700', category: 'Morados', icon: '⚡' },
  { name: 'cosmic-purple', gradient: 'from-violet-500 via-purple-600 to-fuchsia-700', category: 'Morados', icon: '⚡' },
  { name: 'neon-purple', gradient: 'from-purple-400 via-fuchsia-500 to-purple-600', category: 'Morados', icon: '⚡' },
  { name: 'deep-violet', gradient: 'from-violet-600 via-purple-700 to-indigo-800', category: 'Morados', icon: '⚡' },
  
  // ==================== 🌊 CYANS Y TURQUESAS ====================
  { name: 'electric-cyan', gradient: 'from-cyan-300 via-cyan-500 to-blue-600', category: 'Cyans', icon: '🌊' },
  { name: 'ocean-turquoise', gradient: 'from-teal-400 via-cyan-500 to-blue-600', category: 'Cyans', icon: '🌊' },
  { name: 'neon-teal', gradient: 'from-emerald-400 via-teal-500 to-cyan-600', category: 'Cyans', icon: '🌊' },
  { name: 'aqua-blue', gradient: 'from-sky-400 via-cyan-500 to-teal-600', category: 'Cyans', icon: '🌊' },
  { name: 'tropical-cyan', gradient: 'from-cyan-400 via-teal-500 to-emerald-600', category: 'Cyans', icon: '🌊' },
  
  // ==================== 💖 ROSAS Y MAGENTAS ====================
  { name: 'hot-pink', gradient: 'from-pink-400 via-pink-500 to-rose-600', category: 'Rosas', icon: '💖' },
  { name: 'electric-magenta', gradient: 'from-fuchsia-400 via-pink-500 to-purple-600', category: 'Rosas', icon: '💖' },
  { name: 'neon-rose', gradient: 'from-rose-400 via-pink-500 to-fuchsia-600', category: 'Rosas', icon: '💖' },
  { name: 'vibrant-pink', gradient: 'from-pink-500 via-rose-500 to-red-600', category: 'Rosas', icon: '💖' },
  
  // ==================== ⚡ AZULES ELÉCTRICOS ====================
  { name: 'electric-blue', gradient: 'from-blue-400 via-blue-500 to-indigo-600', category: 'Azules', icon: '⚡' },
  { name: 'neon-blue', gradient: 'from-sky-400 via-blue-500 to-violet-600', category: 'Azules', icon: '⚡' },
  { name: 'royal-blue', gradient: 'from-blue-500 via-indigo-600 to-purple-700', category: 'Azules', icon: '⚡' },
  { name: 'sapphire-blue', gradient: 'from-blue-600 via-blue-700 to-indigo-800', category: 'Azules', icon: '⚡' },
  
  // ==================== 🌿 VERDES VIBRANTES ====================
  { name: 'electric-green', gradient: 'from-green-400 via-emerald-500 to-teal-600', category: 'Verdes', icon: '🌿' },
  { name: 'neon-lime', gradient: 'from-lime-400 via-green-500 to-emerald-600', category: 'Verdes', icon: '🌿' },
  { name: 'forest-emerald', gradient: 'from-emerald-500 via-green-600 to-teal-700', category: 'Verdes', icon: '🌿' },
  { name: 'jade-green', gradient: 'from-teal-400 via-emerald-500 to-green-600', category: 'Verdes', icon: '🌿' },
  
  // ==================== 🔥 COLORES CÁLIDOS ====================
  { name: 'electric-orange', gradient: 'from-orange-400 via-orange-500 to-red-600', category: 'Cálidos', icon: '🔥' },
  { name: 'sunset-orange', gradient: 'from-yellow-400 via-orange-500 to-red-600', category: 'Cálidos', icon: '🔥' },
  { name: 'golden-yellow', gradient: 'from-yellow-400 via-amber-500 to-orange-600', category: 'Cálidos', icon: '🔥' },
  { name: 'fire-orange', gradient: 'from-orange-500 via-red-500 to-pink-600', category: 'Cálidos', icon: '🔥' },
  
  // ==================== ✨ GRADIENTES ESPECIALES ====================
  { name: 'aurora-borealis', gradient: 'from-green-400 via-cyan-500 to-purple-600', category: 'Especiales', icon: '✨' },
  { name: 'sunset-dream', gradient: 'from-orange-400 via-pink-500 to-purple-600', category: 'Especiales', icon: '✨' },
  { name: 'ocean-sunset', gradient: 'from-cyan-400 via-blue-500 to-purple-600', category: 'Especiales', icon: '✨' },
  { name: 'rainbow-bridge', gradient: 'from-pink-400 via-purple-500 to-cyan-600', category: 'Especiales', icon: '✨' },
  { name: 'cosmic-nebula', gradient: 'from-indigo-400 via-purple-500 to-pink-600', category: 'Especiales', icon: '✨' },
  { name: 'electric-storm', gradient: 'from-blue-400 via-cyan-500 to-teal-600', category: 'Especiales', icon: '✨' },
  { name: 'neon-nights', gradient: 'from-fuchsia-400 via-purple-500 to-blue-600', category: 'Especiales', icon: '✨' },
  { name: 'crystal-prism', gradient: 'from-violet-400 via-blue-500 to-cyan-600', category: 'Especiales', icon: '✨' },

  // ==================== 🏔️ COLORES TIERRA Y NATURALES ====================
  { name: 'mountain-stone', gradient: 'from-slate-400 via-gray-500 to-zinc-600', category: 'Naturales', icon: '🏔️' },
  { name: 'forest-moss', gradient: 'from-stone-400 via-green-600 to-emerald-700', category: 'Naturales', icon: '🏔️' },
  { name: 'desert-sand', gradient: 'from-amber-300 via-yellow-400 to-orange-500', category: 'Naturales', icon: '🏔️' },
  { name: 'ocean-depth', gradient: 'from-slate-600 via-blue-700 to-indigo-800', category: 'Naturales', icon: '🏔️' },
  { name: 'autumn-leaves', gradient: 'from-orange-600 via-red-600 to-yellow-600', category: 'Naturales', icon: '🏔️' },
  { name: 'winter-frost', gradient: 'from-blue-100 via-slate-200 to-gray-300', category: 'Naturales', icon: '🏔️' },

  // ==================== 🌆 COLORES URBANOS Y MODERNOS ====================
  { name: 'neon-city', gradient: 'from-purple-500 via-pink-400 to-cyan-400', category: 'Urbanos', icon: '🌆' },
  { name: 'chrome-steel', gradient: 'from-gray-400 via-slate-500 to-zinc-600', category: 'Urbanos', icon: '🌆' },
  { name: 'led-blue', gradient: 'from-blue-300 via-cyan-400 to-sky-500', category: 'Urbanos', icon: '🌆' },
  { name: 'traffic-light', gradient: 'from-red-500 via-yellow-400 to-green-500', category: 'Urbanos', icon: '🌆' },
  { name: 'hologram', gradient: 'from-purple-300 via-blue-400 to-cyan-300', category: 'Urbanos', icon: '🌆' },
  { name: 'matrix-green', gradient: 'from-green-600 via-lime-500 to-emerald-400', category: 'Urbanos', icon: '🌆' },

  // ==================== 🍎 COLORES FOOD & LIFESTYLE ====================
  { name: 'strawberry-cream', gradient: 'from-red-300 via-pink-300 to-rose-200', category: 'Lifestyle', icon: '🍎' },
  { name: 'mint-chocolate', gradient: 'from-green-300 via-emerald-400 to-stone-600', category: 'Lifestyle', icon: '🍎' },
  { name: 'caramel-latte', gradient: 'from-amber-400 via-orange-300 to-yellow-200', category: 'Lifestyle', icon: '🍎' },
  { name: 'blueberry-pie', gradient: 'from-blue-400 via-indigo-500 to-purple-400', category: 'Lifestyle', icon: '🍎' },
  { name: 'lavender-honey', gradient: 'from-purple-200 via-violet-300 to-yellow-200', category: 'Lifestyle', icon: '🍎' },
  { name: 'mango-passion', gradient: 'from-yellow-400 via-orange-400 to-red-400', category: 'Lifestyle', icon: '🍎' },

  // ==================== 🌙 COLORES MÍSTICOS Y ESPIRITUALES ====================
  { name: 'moonlight-silver', gradient: 'from-slate-300 via-blue-200 to-indigo-300', category: 'Místicos', icon: '🌙' },
  { name: 'golden-aura', gradient: 'from-yellow-500 via-amber-400 to-orange-400', category: 'Místicos', icon: '🌙' },
  { name: 'crystal-meditation', gradient: 'from-violet-200 via-purple-300 to-blue-200', category: 'Místicos', icon: '🌙' },
  { name: 'sage-wisdom', gradient: 'from-green-300 via-teal-400 to-cyan-300', category: 'Místicos', icon: '🌙' },
  { name: 'phoenix-fire', gradient: 'from-red-600 via-orange-500 to-yellow-400', category: 'Místicos', icon: '🌙' },
  { name: 'deep-space', gradient: 'from-indigo-900 via-purple-800 to-blue-900', category: 'Místicos', icon: '🌙' },

  // ==================== 🎨 COLORES ARTÍSTICOS Y CREATIVOS ====================
  { name: 'watercolor-dream', gradient: 'from-blue-200 via-purple-200 to-pink-200', category: 'Artísticos', icon: '🎨' },
  { name: 'oil-painting', gradient: 'from-red-500 via-orange-600 to-yellow-500', category: 'Artísticos', icon: '🎨' },
  { name: 'pastel-rainbow', gradient: 'from-pink-200 via-blue-200 to-green-200', category: 'Artísticos', icon: '🎨' },
  { name: 'graffiti-wall', gradient: 'from-lime-400 via-cyan-500 to-fuchsia-500', category: 'Artísticos', icon: '🎨' },
  { name: 'vintage-sepia', gradient: 'from-amber-600 via-orange-700 to-red-800', category: 'Artísticos', icon: '🎨' },
  { name: 'neon-art', gradient: 'from-green-400 via-pink-500 to-blue-500', category: 'Artísticos', icon: '🎨' },

  // ==================== 💎 COLORES PREMIUM Y LUJO ====================
  { name: 'diamond-white', gradient: 'from-gray-100 via-slate-200 to-zinc-300', category: 'Premium', icon: '💎' },
  { name: 'platinum-silver', gradient: 'from-slate-400 via-gray-300 to-zinc-400', category: 'Premium', icon: '💎' },
  { name: 'rose-gold', gradient: 'from-pink-300 via-rose-400 to-orange-300', category: 'Premium', icon: '💎' },
  { name: 'champagne-bubbles', gradient: 'from-yellow-200 via-amber-300 to-orange-200', category: 'Premium', icon: '💎' },
  { name: 'black-pearl', gradient: 'from-gray-800 via-slate-700 to-zinc-800', category: 'Premium', icon: '💎' },
  { name: 'royal-velvet', gradient: 'from-purple-800 via-indigo-700 to-violet-800', category: 'Premium', icon: '💎' },

  // ==================== 🚀 COLORES FUTURISTAS Y TECH ====================
  { name: 'cyber-punk', gradient: 'from-fuchsia-500 via-purple-600 to-cyan-500', category: 'Futuristas', icon: '🚀' },
  { name: 'quantum-blue', gradient: 'from-blue-600 via-indigo-700 to-purple-600', category: 'Futuristas', icon: '🚀' },
  { name: 'laser-red', gradient: 'from-red-600 via-pink-500 to-rose-500', category: 'Futuristas', icon: '🚀' },
  { name: 'plasma-green', gradient: 'from-lime-500 via-green-600 to-emerald-600', category: 'Futuristas', icon: '🚀' },
  { name: 'holographic', gradient: 'from-cyan-400 via-purple-500 to-pink-400', category: 'Futuristas', icon: '🚀' },
  { name: 'digital-orange', gradient: 'from-orange-500 via-red-500 to-pink-500', category: 'Futuristas', icon: '🚀' },
